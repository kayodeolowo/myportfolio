  ...
  return (
     <section className='w-full  ' id="skills">
        <div className='w-11/12 md:w-9/12  mx-auto max-w-[1280px]   pt-20 md:pt-24'> 
            ...
            <h2 className='  mt-2 font-fira text-white text-[20px] md:text-[20px]  leading-[35px]  '> With 2 years of experience in Frontend development, my proficient skills are </h2>
