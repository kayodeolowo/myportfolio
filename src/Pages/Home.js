    ...
    <section className='w-full  ' id='home' >
            <div className='w-11/12 md:w-9/12 mx-auto max-w-[1280px]  pt-[120px] '> 
               <div className=''> 
                    ...
                    <h2 className=' mt-6 font-fira text-lg sm:text-xl leading-snug text-gray-100 text-start sm:w-9/12 '>I love to create beautiful and responsive websites with delightful user experiences. Working on creative projects that require exceptional skills and capabalities has shaped me greatly. </h2>
               </div>
