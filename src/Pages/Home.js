    ...
    <section className='w-full  ' id='home' >
            <div className='w-11/12 md:w-9/12 mx-auto max-w-[1280px]  pt-[120px] '> 
               <div className=''> 
                    ...
                    <h1 data-aos="zoom-in" className='mt-6 text-4xl sm:text-4xl md:text-6xl  font-bold text-white font-Source sm:text-start transition ease-in hover:text-[#E0A040] cursor-pointer  duration-500'> kayode Olowo</h1>
