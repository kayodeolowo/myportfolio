    ...
    <section className='w-full  ' id='home' >
            <div className='w-11/12 md:w-9/12 mx-auto max-w-[1280px]  pt-[120px] '> 
               <div className=''> 
                    ...
                    <h1 className='mt-6 text-[39px] sm:text-[45px]  font-bold text-white font-Source sm:text-start '> kayode Olowo</h1>
                     <h1 className='mt-6 md:mt-2 sm:w-9/12 lg:w-7/12 font-semibold leading-snug  text-gray-100 font-fira text-start sm:text-start text-2xl'> I am passionate about building and developing user friendly websites, web based applications and software’s.  </h1>
